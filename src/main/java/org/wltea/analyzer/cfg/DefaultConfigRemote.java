 ...
 *
 */
public class DefaultConfigRemote implements ConfigurationRemote {
	 ...
	 */
	public static ConfigurationRemote getInstance(){
		return new DefaultConfigRemote();
	}

	/*
	 * 初始化配置文件
	 */
	private DefaultConfigRemote(){
